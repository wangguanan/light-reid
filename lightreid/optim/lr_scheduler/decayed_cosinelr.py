...
__all__ = ["DelayedCosineAnnealingLR"]
...
def DelayedCosineAnnealingLR(optimizer, delay_epochs, max_epochs, eta_min_lr, warmup_factor,
                             warmup_epochs, warmup_method='linear'):
    cosine_annealing_iters = max_epochs - delay_epochs
    base_scheduler = CosineAnnealingLR(optimizer, cosine_annealing_iters, eta_min_lr)
    return DelayedScheduler(optimizer, delay_epochs, base_scheduler, warmup_factor, warmup_epochs, warmup_method)
