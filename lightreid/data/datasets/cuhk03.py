...
from lightreid.utils import read_json, write_json, mkdir_if_missing
from .reid_samples import ReIDSamples


class CUHK03(ReIDSamples):
    """CUHK03.
    ...
    def __init__(
        ...
        combineall=False, download=False
    ):
        ...
        super(CUHK03, self).__init__(train, query, gallery, combineall)
