...
CUDA_VISIBLE_DEVICES=0 python main.py --dataset dukemtmcreid --results_dir ./results/dukemtmcreid/
## enable lightmodel, enhance with model distillation
#CUDA_VISIBLE_DEVICES=1 python main.py --dataset dukemtmcreid --results_dir ./results/dukemtmcreid/ --lightmodel True
## enable lightfeat, learn binary codes
#CUDA_VISIBLE_DEVICES=1 python main.py --dataset dukemtmcreid --results_dir ./results/dukemtmcreid/ --lightfeat True
## enable lightfeat and lightsearch, learn binary codes and search with coarse2fine
#CUDA_VISIBLE_DEVICES=1 python main.py --dataset dukemtmcreid --results_dir ./results/dukemtmcreid/ --lightfeat True --lightsearch True
## enable lightmodel, lightfeat and lightsearch, learn resnet18, binary codes and search with coarse2fine
#CUDA_VISIBLE_DEVICES=1 python main.py --dataset dukemtmcreid --results_dir ./results/dukemtmcreid/ --lightmodel True --lightfeat True --lightsearch True
#
## market1501 dataset
## train a vanilla model
