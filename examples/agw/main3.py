...
parser.add_argument('--results_dir', type=str, default='./results2/', help='path to save outputs')
...
head = lightreid.models.BNHead(in_dim=backbone.dim, class_num=datamanager.class_num,
        classifier=lightreid.models.Circle(backbone.dim, datamanager.class_num, scale=args.circle_scale, margin=args.circle_margin))
