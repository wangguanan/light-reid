...
TESTDATA=market
python3 main.py \
--mode visualize --visualize_mode inter-camera \
--train_dataset market --visualize_dataset market \
--resume_visualize_model ./results/res50ibna_combineall_reafasle_colortrue/$TRAINDATA1+$TRAINDATA2+$TRAINDATA3+$TRAINDATA4//model_$EPOCHS.pkl \
